...
def first_order_cut_expansion_impl(g: BLIFGraph, cut: Cut, labels: dict, signal_to_channel: dict, channel_to_signals: dict, cut_size_limit: int, max_expansion_level: int, verbose: bool = False):
    ...
    while True:
        ...
        if curr_expansion_level == 0:
            ...
            if first_order_cut_params.early_terminate_flag and optimal_timing_label <= first_order_timing_label:
